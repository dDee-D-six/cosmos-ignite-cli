...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/username/interchange/dex/buy_order_book
   */
  queryBuyOrderBookAll = (
    ...
    this.request<DexQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/username/interchange/dex/buy_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/interchange/dex/buy_order_book/{index}
   */
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/username/interchange/dex/buy_order_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/username/interchange/dex/denom_trace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DexQueryAllDenomTraceResponse, RpcStatus>({
      path: `/username/interchange/dex/denom_trace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/interchange/dex/denom_trace/{index}
   */
  queryDenomTrace = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetDenomTraceResponse, RpcStatus>({
      path: `/username/interchange/dex/denom_trace/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/username/interchange/dex/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<DexQueryParamsResponse, RpcStatus>({
      path: `/username/interchange/dex/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/username/interchange/dex/sell_order_book
   */
  querySellOrderBookAll = (
    ...
    this.request<DexQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/username/interchange/dex/sell_order_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/interchange/dex/sell_order_book/{index}
   */
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<DexQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/username/interchange/dex/sell_order_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
