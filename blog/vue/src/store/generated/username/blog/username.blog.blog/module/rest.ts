...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/username/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
    ...
    this.request<BlogQueryAllCommentResponse, RpcStatus>({
      path: `/username/blog/blog/comment`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/username/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/username/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/username/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
